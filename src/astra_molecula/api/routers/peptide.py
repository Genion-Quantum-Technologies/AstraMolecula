...
from astra_molecula.schemas.requests.basic_request import PeptideOptimizationRequest
...
from astra_molecula.core.config import ROOT, storage as storage_config
