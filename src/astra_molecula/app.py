"""
AstraMolecula FastAPI Application
"""
...
from astra_molecula.api.routers import auth, tasks, uploads, smiles, docking, peptide, logs, admin, public, payments
...
try:
    ...
    from astra_molecula import ROOT
