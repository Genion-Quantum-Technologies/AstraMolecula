...
import io
# 你的其他 imports 保持不变 … 
from astra_molecula.utils.generate import GenerateRunner
from astra_molecula.utils.dataset import Dataset
from astra_molecula.utils.combine_mol import connect_constVar_try
import torch
import astra_molecula.utils.sascorer as sascorer
